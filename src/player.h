...
public:
    ...
    Player(Game *game);                             // Player object constructor
    ~Player();                                      // Player object de-constructor
    Game *game_;                                    // Game instance to pass events to
    ...
    void resetVelocity();                           // Sets vertical velocity to 0
    ...
    void incJump();                                 // Increments the jump value
...
private:
    ...
    sf::Time jumpingDelay;      // Delay cap for jumping again
    ...
    int jumpcount;
        ...
        const float kMaxGravity = 20.f;         // Maximal velocity generated by drag force
       // const float kMinGravity = 0.f;        // Minimal velocity reached while jumping
       // const float kDownDragAccel = 20.f;    // For fast drop-down while pressing DOWN
        const float kJumpAccel = -40.f;         // Velocity written directly after jump execution
